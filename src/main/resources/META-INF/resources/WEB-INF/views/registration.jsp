                            ...
                            <div class="col-lg-6 order-1 order-lg-2 d-flex align-items-center justify-content-center">
                                <div class="signup-form-wrapper">
                                    ...
                                    <div class="signup-inner text-center">
                                        ...
                                        <form class="signup-inner--form" action = "/registration" method = "POST">
                                            <div class="row">
                                                <div class="col-12">
                                                    <input type="email" class="single-field" placeholder="Email" name = "email" required>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="single-field" placeholder="First Name" name = "firstName" required>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="single-field" placeholder="Last Name" name = "lastName" required>
                                                </div>
                                                <div class="col-12">
                                            ...
                                            <h6 class="terms-condition">Already have an account? <a href="/">Sign In</a></h6>
                                        </form>
                                    </div>
                                </div>
                            </div>
